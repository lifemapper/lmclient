...
class TaxonomyApiService(RestService):
    ...
    # ...........................
    def list(self, raw=False, canonical_name=None, limit=None,
             scientific_name=None, squid=None, taxon_class=None,
             taxon_family=None, taxon_genus=None, taxon_key=None,
             taxon_kingdom=None, taxon_order=None, taxon_phylum=None,
             user=None):
        """Gets a list
        ...
        return RestService.list(self,
            self.end_point, raw=raw, canonical_name=canonical_name,
            limit=limit, scientific_name=scientific_name, squid=squid,
