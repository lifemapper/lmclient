...
class TreeApiService(RestService):
    ...
    def delete(self, tree_id):
        ...
        return RestService.delete(
            self, '{}/{}'.format(self.end_point, tree_id))
    ...
    # ...........................
    def list(self, after_time=None, before_time=None, has_branch_lengths=None,
             is_binary=None, is_ultrametric=None, limit=None, meta_string=None,
             name=None, offset=None, user=None):
